        ...
        return (React.createElement(LocaleProvider, { locale: zhCN },
            React.createElement("div", { className: classnames(mainClassName, {
                ...
                React.createElement("div", { className: mainClassName + "-right" },
                    ...
                    activeTab === 'elementsPane' && React.createElement(ElementsPane, { key: "ElementsPane-" + activeId, activeId: activeId }),
                    activeTab === 'virtualDomTree' && React.createElement(VirtualDomTree, { key: "VirtualDomTree-" + activeId, activeId: activeId, virtualDomData: virtualDomData, onChange: this.handleVirtualDomTreeChange, onActiveIdChange: this.handleActiveIdChange }),
                    activeTab === 'propertyInfo' && React.createElement(PropertyInfo, { key: "PropertyInfo-" + activeId, activeId: activeId, virtualDomData: virtualDomData, onChange: this.handleVirtualDomTreeChange })))));
    };
