...
import { nameMapToDefaultStyle, nameMapToLabel, propertyInfoClassName } from '../../constant';
...
var PropertyInfo = /** @class */ (function (_super) {
    ...
    PropertyInfo.prototype.render = function () {
        ...
        return (React.createElement("div", { className: propertyInfoClassName },
            React.createElement(Collapse, { defaultActiveKey: ["general"] },
