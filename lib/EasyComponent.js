...
var EasyComponent = /** @class */ (function (_super) {
    ...
    EasyComponent.prototype.render = function () {
        var _this = this;
        var _a = this.state, virtualDomData = _a.virtualDomData, activeId = _a.activeId, actionButtonList = _a.actionButtonList, status = _a.status;
        return (React.createElement(LocaleProvider, { locale: zhCN },
            React.createElement("div", { className: classnames("easy-component", {
                ...
                React.createElement("div", { className: "left" },
                    React.createElement("header", { className: "header" }, actionButtonList.map(function (actionButton) {
                        var title = actionButton.title, icon = actionButton.icon, key = actionButton.key;
                ...
                React.createElement("div", { className: "right" },
                    React.createElement(Tabs, null,
                        React.createElement(TabPane, { tab: "\u5143\u7D20", key: "1" },
                            " ",
                            React.createElement(ElementsPane, null)),
                        React.createElement(TabPane, { tab: "\u7ED3\u6784", key: "2" },
                            React.createElement(VirtualDomTree, { activeId: activeId, virtualDomData: virtualDomData, onChange: this.handleVirtualDomTreeChange, onActiveIdChange: this.handleActiveIdChange })),
                        React.createElement(TabPane, { tab: "\u5C5E\u6027", key: "3" },
                            React.createElement(PropertyInfo, null)))))));
    };
